{{-- Form starts --}}
    <form action="{{route('logincontroller.loginSubmit')}}" method="post">
      @csrf
      ...
      <div class="max-w-md mx-auto">
        <div class="flex items-center space-x-5">
          ...
          <div class="self-start block pl-2 text-xl font-semibold text-gray-700">
            <h2 class="leading-relaxed">LogIn Form</h2>
        ...
        <div class="divide-y divide-gray-200">
          ...
          <div class="flex items-center pt-4 space-x-4">
              <a href="signupform" class="flex items-center justify-center w-full px-4 py-3 text-white bg-blue-500 rounded-md focus:outline-none">New User</a>
         
              <button type="submit" name="" class="flex items-center justify-center w-full px-4 py-3 text-white bg-blue-500 rounded-md focus:outline-none">Login</button>
          </div>
          <div class="">
              <a href="#" class="flex items-center justify-center w-full px-4 py-3 text-blue-900 rounded-md focus:outline-none">
                 Forgot Password ?
              </a>
          </div>
